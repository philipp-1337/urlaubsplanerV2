...
const Footer = () => {
  ...
  return (
    <footer className="bg-gray-100 text-center py-6 pb-[calc(1.25rem+env(safe-area-inset-bottom)/2)] pl-[env(safe-area-inset-left)] pr-[env(safe-area-inset-right)] shrink-0">
